...
* Navigate a body of water usinga predetermined path
* Calulate its GPS coordinates with centimeter level precision and accuracy
* Can cover a 56 acre body of water during its battery life which is about 3 hours
* Transmit GPS and battery voltage data to a PC in real time.
